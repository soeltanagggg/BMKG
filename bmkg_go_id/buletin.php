...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #F3F3F3; border-radius: 5px; height: 1000px; width: 800px;">
                <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #C4C4C4; padding-top: auto; align-content: center; margin-left: 90px; margin-bottom: 700px; border-radius: 15px; height: 260px; width: 600px;"> <img src="./assets/images/gedung.png" style="width: 460px; height: 200px; margin: 70px;">
                </nav>
        ...
        <div class="row">
             <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #56BBD1; border-radius: 5px; height: 60px; width: 200px; margin-top: -745px; margin-left: 280px;"> <p style="color: #00000; font-family: Roboto; margin: 50px; text-align: center; font-size: 24px;">Sejarah</p> 
