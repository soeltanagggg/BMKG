...
<body>
    ...
    <div class="container">
        ...
        <div class="row" style="margin-top:-330px ;">
            <div class="col-6">
                <nav class="navbar navbar-expand-lg">
                    <p style="text-align:justify; margin-left:55px; margin-top:-1150px; font-size:20px">Stasiun Meteorologi Klas I Serang berdiri pada tahun 1946 diawali sebagai Pos Pengamat Hujan, Kemudian Tahun 1974 berubah menjadi Unit Pelaksana Teknis (stasiun synoptik) non-basic berlokasi didekat di Rumah Sakit Umum Serang-Banten. Selanjutnya pada tahun 1984 Pindah ke Jln. Taktakan No. 27 Serang. Mengalami pergantian Kepala Stasiun sebanyak 10 kali :
                    </p>
                </nav>
            </div>
        </div>
        <div class="row" style="margin-left:55px; ">
            <div class="col-6">
                <nav class="navbar navbar-expand-lg">
                    <ol style="margin-top: -650px; font-size:20px;">
                        <li>Zaenal: Tahun 1946 s.d 1957</li>
                        <li>Djadjamihardja: Tahun 1957 s.d 1974</li>
                        <li>T.Khadis, BA: Tahun 1974 s.d 1978</li>
                        <li>A.Rakhim Iyang: Tahun 1978 s.d 1988/li>
                        <li>A.Soerdjana: Tahun 1988 s.d 1992</li>
                        <li>Harun Pohan: Tahun 1992 s.d 2002</li>
                        <li>Drs. Edi Kelana S: Tahun 2002 s.d 2008</li>
                        <li>Drs. Nanang Purnadi: Tahun 2008 s.d 2011</li>
                        <li> Parmin, S.Si,MM: Tahun 2011 s.d 2017</li>
                        <li> Sugarin, S.Si: Tahun 2017 s.d 2018</li>
                        <li>Fachkrurazi, SP: Tahun 2018 sampai dengan sekarang</li>
                    </ol>
                </nav>
            </div>
        </div>
