...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #F3F3F3; border-radius: 5px; height: 1000px; width: 800px;"><img src="./assets/images/so.png" style="border-radius: 20px; width:1800px; height: 1000px;">
